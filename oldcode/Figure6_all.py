...
for i in range(4):
    ax[0].plot(D14C_NP[i].year,D14C_NP[i].D14CintNP,linewidth=linewidths[i],ls=linestyles[i],marker=markers[i],markeredgecolor='k',markerfacecolor='white',color = colors[i],label= labels[i])
    ax[1].plot(IS_D14C_NP[i].year,IS_D14C_NP[i].D14CintNP,linewidth=linewidths[i],ls=linestyles[i],marker=markers[i],markeredgecolor='k',markerfacecolor='white',color = colors[i],label= ISlabels[i])
